...
exports.mergeNestedBool = mergeNestedBool;
...
function mergeNestedBool() {
  var merged = {};

  for (var _len = arguments.length, nested = Array(_len), _key = 0; _key < _len; _key++) {
    nested[_key] = arguments[_key];
  }
