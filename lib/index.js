...
function bodybuilder() {
  ...
  return Object.assign({
    ...
    build: function build(version) {
      ...
      var nested = this.getNestedBool();
      //const mergedNested = mergeNestedBool(...nested.should)
  ...
  }, (0, _queryBuilder2.default)(), (0, _filterBuilder2.default)(), (0, _nestedBuilder2.default)(), (0, _aggregationBuilder2.default)());
}
...
function _build(body, queries, filters, aggregations, nested) {
  ...
  if (!(0, _isEmpty2.default)(nested)) {
    var nestedBody = {};
    (0, _set2.default)(nestedBody, 'query.bool.filter', nested);
    (0, _merge2.default)(clonedBody, nestedBody);
  }
